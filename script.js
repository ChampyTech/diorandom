...
const oggetti = [
    ...
    "Canaglia", "Cancar@", "Cancaros@", "Reazione Chimica", "Furgoncino dei Gelati", "Camioncino dei Gelati", "Deodorante", "Soggetto Economico", "Kane/Kagna", "Vakka", "Vatican@", "Pork@", "Strapork@", "Kretin@", "Strakretin@", "Attestato di Partecipazione", "Burrocacao alla Menta", "Erba Aromatica", "Kankar@", "Strakankar@", "Stracancar@", "Kankaros@", "Strakankaros@", "Vatikan@", "Previsione del Meteo", "Tempo Meteorologico", "Skifos@", "Straskifos@", "Guardrail", "Merdos@", "Scanat@", "Incubatrice", "Costituzione Italiana", "Costituzione Americana", "Bengalese", "Indian@", "DNA", "Visual Studio Code", "Nicaraguense", "Antiguo-barbudan@", "Cuban@", "Atroce", "Bruciat@", "Suin@", "T-shirt", "T-rex", "Canestro", "Chihuahua", "Scimmia", "Avocado", "Gorilla", "Orangotango", "Pallavolista", "Bruschetta", "Cristoforo Colombo"
];
