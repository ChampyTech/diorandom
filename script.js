...
const aggettiviMaschili = [
    "Kinder Bueno", "GPT", "AI", "PowerPoint", "Microsoft Word", "PDF", "Onto", "Vento", "Fulmine",
    "WiFi", "Router", "Mouse", "Webcam", "Cloud", "Bluetooth", "Auricolare", "Cicoria", "Tiramisù",
    "Smartwatch", "SSD", "USB-C", "Cavo HDMI", "Stampante", "Tastiera", "Pittore", "Infame", "Terra",
    "Minecraft", "Crafting Table", "Joystick", "Meccanico", "Ingegnere", "Programmatore", "Porcone",
    ...
    "Casse Bluetooth", "Cucchiaio Sporco", "Bidet Intelligente", "Pixelato", "Gatto", "Piatto", "Tazza",
    "Cucchiaio", "Letto", "Doccia", "Sedia", "Frigorifero", "Cuscino", "Armadio", "Tavolo", "Fumo",
    "Cimice", "Ragno", "Formica", "Neve", "Sabbia", "Nebbia", "Tram", "Fango", "Tuono",
    ...
    "Wireless", "Sistema di Raffreddamento", "Ombrellone", "eBook", "Email", "Costaricense",
    ...
    "Kane", "Vakka", "Vaticano", "Porko", "Straporko", "Kretino", "Strakretino",
    ...
    "Cotoletta alla Bolognese", "Spaghetti alla Carbonara", "Pasta all'Amatriciana", "Pasticcio di Carne", "Vespone",
...
const aggettiviFemminili = [
    "Kinder Bueno", "GPT", "AI", "PowerPoint", "Microsoft Word", "PDF", "Onta", "Benzinaia", "Falegname", "Infame",
    "WiFi", "Router", "Mouse", "Webcam", "Cloud", "Bluetooth", "Auricolare", "Insegna", "Semaforo", "Panchina",
    "Smartwatch", "SSD", "USB-C", "Cavo HDMI", "Stampante", "Tastiera", "Puttana", "Campanello", "Campana",
    ...
    "YouTuber", "Social Media Manager", "Forno Elettrico", "Carta Igienica", "Tram di Milano", "Boia",
    "Casse Bluetooth", "Cucchiaio Sporco", "Bidet Intelligente", "Pixelata", "Porcona", "Statua", "Manichino",
    "Cagna", "Maiala", "Asina", "Pavone", "Gatto", "Piatto", "Tazza", "Tram", "Vigile", "Parrucchiera", "Pescatrice",
    "Cucchiaio", "Letto", "Doccia", "Sedia", "Frigorifero", "Cuscino", "Armadio", "Tavolo", "Fontana", "Cicoria",
    "Cimice", "Ragno", "Formica", "Neve", "Fumo", "Nebbia", "Cavaliera", "Merda",
    "Vento", "Fulmine", "Tuono", "Fango", "Sabbia", "Terra", "Sasso", "Cemento", "Postina", "Tiramisù",
    "Pannello", "Secchio", "Serpente", "Muro", "Porta", "Finestra", "Tappeto", "Coperta", "Merdina",
    "Lavatrice", "Forno", "Bidet", "Cesso", "Lavandino", "Cassa", "Minestra", "Dinosauro", "Mummia", "Fantasma",
    ...
    "Cuscino Riscaldabile", "Mini Scaldapiedi", "Friggitrice Senza Olio", "Scaldapiedi", "5G Ultra Fold", "5G",
    "Wireless", "Sistema di Raffreddamento", "Ombrellone", "eBook", "Email", "Costaricense",
    "Precipitevolissimevolmente", "Supercalifragilistichespiralidoso", "Mary Poppins", "Cieca", "Segmento",
    ...
    "Kagna", "Vakka", "Vaticana", "Porka", "Straporka", "Kretina", "Strakretina", "Deodorante",
    ...
    "T-shirt", "T-rex", "Canestro", "Chihuahua", "Scimmia", "Avocado", "Gorilla", "Orangotango", "Pallavolista", "Bruschetta",
    "Cristoforo Colombo", "Homo Sapiens", "Australopiteco", "Bassotto", "Cocomero Marcio", "Anguria andata a Male",
    "Tagliatelle al Cinghiale", "Cinghiale", "Orso", "Orsa", "Pellerossa", "Postamat", "Carta Fedeltà", "NaCl", "Rotaia",
    "Gruppo Vacanze", "Swiffer", "Penna Scarica", "Penna Usata", "Pezzente", "Cover per Telefoni", "HTML", "CSS", "Alighieri",
    "Petrarca", "Boccaccio", "Tasso", "Leopardi", "Manzoni", "Pascoli", "Ungaretti", "Montale", "D'Annunzio", "Foscolo",
    "Carducci", "Cavolfiore", "Melanzana", "Pomodoro", "Cetriolo", "Finocchio", "Peperone", "Carota", "Zucchina", "Lattuga",
    "Radicchio", "Rucola", "Bietola", "Cipolla", "Aglio", "Broccolo", "Fagiolino", "Asparago", "Porro", "Sedano",
    ...
    "Libellula", "Ragno", "Scorpione", "Lumaca", "Chiocciola", "Verme", "Larva", "Camaleonte", "Iguana", "Drago Barbuto",
    "Lucertola", "Gecko", "Salamandra", "Tritone", "Rospo", "Rana", "Anfisbena", "Colibrì", "Mangusta", "Tapiro", "Antenato",
    "Cervo", "Alce", "Gru", "Bufalo", "Antilope", "Gnu", "Lama", "Pecora", "Maiale", "Mucca", "Cavallo", "Asina",
    "Asino", "Criceto", "Porcospino", "Toporagno", "Scoiattolo Volante", "Furetto", "Lontra", "Castoro", "Ghiro",
